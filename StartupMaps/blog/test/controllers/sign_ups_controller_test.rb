...
class SignUpsControllerTest < ActionController::TestCase
  ...
  test "should create sign_up" do
    assert_difference('SignUp.count') do
      post :create, sign_up: { email: @sign_up.email, password: @sign_up.password, username: @sign_up.username }
    end
  ...
  test "should update sign_up" do
    patch :update, id: @sign_up, sign_up: { email: @sign_up.email, password: @sign_up.password, username: @sign_up.username }
    assert_redirected_to sign_up_path(assigns(:sign_up))
  end
