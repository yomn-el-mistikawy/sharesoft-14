class MapsController < ApplicationController
  ...
  def Index
    ...
    @startup_marker = Gmaps4rails.build_markers(@startups) do |startup, marker|
    ...
    @service_marker = Gmaps4rails.build_markers(@services) do |service, marker|
    ...
    @investor_marker = Gmaps4rails.build_markers(@investors) do |investor, marker|
